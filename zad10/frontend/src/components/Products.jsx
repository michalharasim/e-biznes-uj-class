...
const Products = () => {
  ...
  useEffect(() => {
    axios
      .get("https://zad10backendapp-e4eebcg9d4drc3hg.westeurope-01.azurewebsites.net/products")
      .then((response) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      await axios.post("https://zad10backendapp-e4eebcg9d4drc3hg.westeurope-01.azurewebsites.net/payment", {
        cart: { products: cart },
        totalPrice: sum,
